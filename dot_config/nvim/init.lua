-- :help lua-guide :telescope :help option-list
-- NOTE keymap "<space>sh" to [s]earch the [h]elp documentation
vim.g.mapleader = ' '
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function() --  :Telescope help_tags
      -- Insert mode: <c-/> - Normal mode: ? : See `:help telescope` and `:help telescope.setup()`
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Opens a popup that displays documentation about the word under your cursor See `:help K` for why this keymap.
          ...
          --    See `:help CursorHold` for information about when this is executed When you move your cursor, the highlights will be cleared (the second autocommand).
